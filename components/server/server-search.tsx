...
// &#x2718; cross mark use it in place of ctrl if you want
//The onSelect event is used to handle the selection of text within an input or textarea element. It is triggered when the user selects a portion of text within these elements.